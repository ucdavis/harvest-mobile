  ...
  es: {
    ...
    components: {
      expenseQueue: {
        ...
        subtitle: "Mostrando estado de sincronizacion de gastos",
        emptyQueue: "No hay gastos en cola",
        clearAlertTitle: "Limpiar cola de gastos",
        clearAlertMessage:
          "Seguro que quieres eliminar %{count} gastos de la cola? Esta accion no se puede deshacer.",
        ...
        createdLabel: "Creado:",
        syncAttemptsLabel: "Intentos de sincronizacion:",
      ...
      projectsList: {
        ...
        clearSearchAccessibilityLabel: "Limpiar busqueda",
        ...
        adjustSearchTerms: "Intenta ajustar tus terminos de busqueda",
      ...
      ratesList: {
        ...
        adjustSearchOrFilters:
          "Intenta ajustar tus terminos de busqueda o filtros",
